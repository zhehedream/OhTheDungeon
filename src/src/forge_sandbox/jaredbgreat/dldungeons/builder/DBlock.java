...
//		if(theBlock == null) {
//			String error = "[OTD] ERROR! Block read as \"" + id 
...
//	}
	...
	public void place(World world, int x, int y, int z) {
        ...
        public void placeAsync(HalfAsyncWorld world, int x, int y, int z) {
            world.setType(x, y, z, block, false);
	}
	...
	public static void place(World world, int x, int y, int z, int block) {
        ...
        public static void placeAsync(HalfAsyncWorld world, int x, int y, int z, int block) {
            registry.get(block).placeAsync(world, x, y, z);
	}
	...
	public static boolean placeBlockAsync(HalfAsyncWorld world, int x, int y, int z, BlockData block) {
                if(isProtectedBlock(world, x, y, z)) return false;
                world.setBlockData(x, y, z, block, false);
		return true;
	}
        ...
        public static boolean placeBlockAsync(HalfAsyncWorld world, int x, int y, int z, Material block) {
                if(isProtectedBlock(world, x, y, z)) return false;
                world.setType(x, y, z, block, false);
		return true;
	}
...
//	}
	...
	public static void deleteBlock(World world, int x, int y, int z) {
        ...
        public static void deleteBlockAsync(AsyncWorldEditor world, int x, int y, int z) {
                world.setBlockType(x, y, z, air);
	}
	...
	public static void deleteBlock(World world, int x, int y, int z, boolean flooded) {
        ...
        public static void deleteBlockAsync(HalfAsyncWorld world, int x, int y, int z, boolean flooded) {
            if(isProtectedBlock(world, x, y, z)) return;
            if(flooded) placeBlockAsync(world, x, y, z, water); 
            else world.setType(x, y, z, air, false);
	}
...
//	    logic.setNextSpawnData(new WeightedSpawnerEntity(1, spawnData));
	...
	public static boolean isGroundBlock(World world, int x, int y, int z) {
        ...
        public static boolean isGroundBlockAsync(HalfAsyncWorld world, int x, int y, int z) {
	...
	public static boolean isProtectedBlock(World world, int x, int y, int z) {
        ...
        public static boolean isProtectedBlock(HalfAsyncWorld world, int x, int y, int z) {
        Material block = world.getType(x, y, z);
        return (block == chest || block == spawner
                || block == portal1 || block == portal2);
    }
